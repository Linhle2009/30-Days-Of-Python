...
# Example 1: For instance if you want to change a string to a list of characters:
# One way
language = 'Python'
...
# Example:2 For instance if you want to generate a list of numbers:
# Generating numbers
...
## 2.2. Lambda Function Inside Another Function:
def power(x):
    return lambda n : x ** n
